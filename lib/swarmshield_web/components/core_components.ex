defmodule SwarmshieldWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SwarmshieldWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SwarmshieldWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SwarmshieldWeb.Gettext, "errors", msg, opts)
    end
  end
